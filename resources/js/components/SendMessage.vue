		                        ...
		                        <div class="col-span-3 sm:col-span-2">
		                            ...
		                            <div class="mt-1">
		                                <input type="email" name="recipientEmail" id="recipientEmail" placeholder="receiver@gmail.com"
		                                	...
		                                	class="form-input focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm shadow-lg border border-gray-300">
		                            </div>
		                        </div>
		                    </div>
		                    <div>
		                    ...
		                    <div>
		                        ...
		                        <div class="mt-1">
		                            <textarea id="bodyAsText" name="bodyAsText" rows="3" placeholder="Hello, thank you."
		                            	...
		                            	class="form-textarea shadow-lg focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"></textarea>
		                        </div>
		                    </div>
		                    <div>
