	                    ...
	                    <div>
	                        ...
	                        <div class="mt-1">
	                            <textarea id="bodyAsText" name="bodyAsText" rows="3" placeholder="Hello, thank you."
	                            	...
	                            	class="form-textarea shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
	                        </div>
	                    </div>
	                    <div>
